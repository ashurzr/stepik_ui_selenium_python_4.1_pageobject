...
class ProductPageLocators():
    ...
    ITEM_PRICE = (By.CSS_SELECTOR, "div.alert-info div.alertinner p strong")

    # получим <selenium.webdriver.remote.webelement.WebElement (session="8cf53978b2a681aede9bcecfb1f49910", element="f.0D0A1099B07B827BB26ACB36F5576C0C.d.FD3AAC3E1AF87C258F48A0A756E6924B.e.23")>
    ITEM_PRICE_IN_CART_MESSAGE = (By.XPATH, "//div[@class='basket-mini pull-right hidden-xs']")
